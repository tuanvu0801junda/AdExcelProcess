...
public class ErrorExcelHandler {
    private static final String errExcelPath = System.getProperty("user.home") + "/Downloads/uploads/Error.xlsx";
    public static final int SHEET_NAME_COL = 0;
    public static final int HEADER_NAME_COL = 1;
    public static final int ROW_NUM_COL = 2;
    public static final int ERR_MSG_COL = 3;

    public static Workbook getWorkbookToWrite(String excelPath) throws IOException{
        // File extension: XLSX
    ...
    public static void writeEachRow(ErrorExcel errorExcel, Row row){
        Cell cell = row.createCell(SHEET_NAME_COL);
    ...
    public static void createOutputFile(Workbook workbook){
        try{
    ...
    public static void writeErrorExcel(ArrayList<ErrorExcel> errExcelList) throws IOException{
